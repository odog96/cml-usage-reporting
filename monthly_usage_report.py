...
def main():
    ...
    for resource_type in resource_types:
        ...
        if usage_data['success']:
            ...
            csv_filename = f"monthly_{resource_type}_usage_{year}_{month:02d}.csv"
    ...
    if successful_resources:
        ...
        combined_filename = f"monthly_combined_usage_{year}_{month:02d}.csv"
    ...
    # Save JSON report
    json_filename = f"monthly_report_{year}_{month:02d}.json"
